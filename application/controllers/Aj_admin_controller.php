...
class Aj_admin_controller extends Admin_Core_Controller
{
    ...
    */
    ...
    public function contact_messages()
    {
        ...
        $this->contact_model->update_unread_to_read();
    ...
    */
    ...
    public function administrators()
    {
        ...
        $data['users'] = $this->auth_model->get_administratorsUser();
    ...
    public function change_password_post()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if ($this->auth_model->change_password_admin()) {
    ...
    {
        $data['title'] = trans("edit_administrator");
    ...
    public function add_administrator_post()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->auth_model->is_unique_admin_username($username)) {
                $this->session->set_flashdata('form_data', $this->auth_model->input_values());
            ...
            if (!$this->auth_model->is_unique_admin_email($email)) {
                $this->session->set_flashdata('form_data', $this->auth_model->input_values());
            ...
            if ($this->auth_model->add_administrators()) {
    ...
    {
        $id = $this->input->post('id', true);
        if ($this->auth_model->delete_admin($id)) {
            $this->session->set_flashdata('success', trans("msg_user_deleted"));
        } else {
            $this->session->set_flashdata('error', trans("msg_error"));
        }
