...
class transaksi_controller extends Home_Core_Controller
{
    ...
    public function transaksi()
    {
        ...
        $pagination = $this->paginate(lang_base_url() . 'transaksi', $this->order_model->get_transaksi_count($this->user_id), $this->order_per_page);
        $data['transaksi'] = $this->order_model->get_paginated_transaksi($this->user_id, $pagination['per_page'], $pagination['offset']);
...
public function transaksi_detail($transaksi_number)
    {
        $data['title'] = trans("orders");
        $data['description'] = trans("orders") . " - " . $this->app_name;
        $data['keywords'] = trans("orders") . "," . $this->app_name;
        ...
        $data["transaksi"] = $this->order_model->get_transaksi_by_transaksi_number($transaksi_number);
        if (empty($data["transaksi"])) {
            redirect(lang_base_url());
        }
        if ($data["transaksi"]->user_id != $this->user_id) {
            redirect(lang_base_url());
        }
