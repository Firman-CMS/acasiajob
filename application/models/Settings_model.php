...
class Settings_model extends CI_Model
{
    ...
    public function update_midtrans_settings()
    {
        $data = array(
            ...
            'midtrans_api_url_live' => trim($this->input->post('midtrans_api_url_live', true)),
            'midtrans_api_url_sandbox' => trim($this->input->post('midtrans_api_url_sandbox', true)),
            'midtrans_server_key_live' => trim($this->input->post('midtrans_server_key_live', true)),
            'midtrans_server_key_sandbox' => trim($this->input->post('midtrans_server_key_sandbox', true))
        );
    ...
    public function update_pricing_settings()
    {
        $data = array(
            ...
            'price_per_week' => $this->input->post('price_per_week', true),
            'price_per_month' => $this->input->post('price_per_month', true)
        );

        $data['price_per_day'] = price_database_format($data["price_per_day"]);
        $data['price_per_week'] = price_database_format($data["price_per_week"]);
