...
class Order_model extends CI_Model
{
    ...
    public function get_orders_count($user_id)
    {
	 ...
	 public function get_transaksi_count($user_id)
    {
        $user_id = clean_number($user_id);
    ...
    public function get_paginated_orders($user_id, $per_page, $offset)
    {
	 ...
	 public function get_paginated_transaksi($user_id, $per_page, $offset)
    {
        $user_id = clean_number($user_id);
        $this->db->where('user_id', $user_id);
    ...
    public function get_order_products($order_id)
    {
	 ...
	 public function get_transaksi_products($id)
    {
        $order_id = clean_number($id);
        $this->db->where('id', $id);
        $query = $this->db->get('promoted_transactions');
        return $query->result();
    }
    ...
    public function get_transaksi_by_transaksi_number($transaksi_number)
    {
        $transaksi_number = clean_number($transaksi_number);
        $this->db->where('id', $transaksi_number);
        $query = $this->db->get('promoted_transactions');
        return $query->row();
    }
