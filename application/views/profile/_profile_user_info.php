...
<div class="section--grey mobile-view-profile">

<div class="clearfix"></div>
<div class="mb-seller-profile">
<div class="container info-wrapper">
<div class="mb-seller-profile__image">
<a href="#"><img backup_img="avatar" class="" src="<?php echo get_user_avatar($user); ?>" alt="<?php echo get_shop_name($user); ?>"></a>
</div>
<div class="seller-profile__basic-info">
<div class="seller_name"><?php echo get_shop_name($user); ?></div>
...
<?php if (user()->id != $user->id): ?>
 ...
 <?php else: ?>
   <a class="seller-profile-edit-btn" href="<?php echo lang_base_url(); ?>settings/update-profile">
Edit
</a>	&nbsp;
<a class="seller-profile-edit-btn" href="<?php echo base_url(); ?>logout">
Keluar
</a>
 <?php endif; ?>
</div>
