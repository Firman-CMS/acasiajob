...
<?php endif; ?>
    <div class="row-custom meta">
        	...
        	<?php echo trans("by"); ?>&nbsp;<?php echo html_escape($product->penjual); ?></a>
        	 <?php else: ?>
...
<div class="row-custom m-t-10">
	...
	<div class="row-custom m-t-10">
        	<?php if ($product->image):?>
        <a href="tel:<?php echo html_escape($product->hape); ?>" target="_blank" class="btn btn-favorite"><i class="icon-phone"></i>Hubungi penjual : <?php echo html_escape($product->hape); ?></a>
     <?php else: ?> 
