...
<div class="row">
    <div class="col-12">
        <div class="product-description">
            <h4 class="section-title"><?php echo trans("description"); ?> BARANG</h4>
...
<?php if ($product->product_type == 'physical' && $product->country_id != 0): ?>
            <div class="item-details">
                <div class="left">
                    <label><b><?php echo trans("location"); ?></b></label>
                </div>
                <div class="right">	<?php if ($product->image):?>
                    <span><?php echo html_escape($product->provinsi); ?>,<?php echo html_escape($product->kabupaten); ?>,<?php echo html_escape($product->kecamatan); ?>,<?php echo html_escape($product->alamat); ?>,<?php echo get_location($product); ?></span>
                <?php else:?>
