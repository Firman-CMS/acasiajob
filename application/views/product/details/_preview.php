...
<?php if ($product->image):?>
 <div class="product-image-preview">
                    <a class="image-popup lightbox" href="<?php echo html_escape($product->image); ?>" data-effect="mfp-zoom-out" title="<?php echo html_escape($product->title); ?>">
                        <img src="<?php echo html_escape($product->image); ?>" alt="<?php echo html_escape($product->title); ?>" class="img-fluid">
                    </a>
                </div>
				<?php else: ?>
<?php $image_count = 0;
