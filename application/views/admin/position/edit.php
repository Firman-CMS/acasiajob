    ...
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo trans("update_job_position"); ?></h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('aj_position_controller/edit_post'); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="status" value="0" id="show_image_on_navigation_2" class="square-purple" <?php echo ($position->status==0 ? 'checked' : '');?>>
