    ...
    <div class="container">
        <div class="row">
            <div id="content" class="col-12">
                ...
                <h1 class="page-title page-title-product">Jual barang 5x lebih cepat,promosikan sekarang!</h1>
                ...
                <div class="form-add-product">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-12 col-lg-10">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 m-b-30">
                                    <div id="pricing_card_2" class="card pricing-card <?php echo ($type == "exist") ? 'selected-card' : ''; ?>">
                                        <div class="card-header">
                                            <h3 class="title">
                                                <span class="currency"><?php echo get_currency($payment_settings->promoted_products_payment_currency); ?></span><span><?php echo price_format($payment_settings->price_per_day); ?></span><span class="period">/2 <?php echo trans("day"); ?></span>
                                            </h3>
                                        </div>
                                        <div class="card-block">
                                            <h4 class="card-title">
                                ...
                                <!-- mingguan -->
								<div class="col-12 col-sm-6 col-md-4 m-b-30">
                                    <div id="pricing_card_4" class="card pricing-card">
                                        <div class="card-header">
                                            <h3 class="title">
                                                <span class="currency"><?php echo get_currency($payment_settings->promoted_products_payment_currency); ?></span><span><?php echo price_format($payment_settings->price_per_week); ?></span><span class="period">/ Minggu</span>
                                            </h3>
                                        </div>
                                        <div class="card-block">
                                            <h4 class="card-title">
                            ...
                            $price_per_week = price_format($payment_settings->price_per_week);
                            ...
                            <input type="hidden" id="price_per_week" value="<?php echo $price_per_week; ?>">
                            ...
                            <div class="container-pricing-card" id="container_pricing_card_2" <?php echo ($type == "exist") ? 'style="display:block;"' : ''; ?>>
                                ...
                                <div class="container-pricing-card" id="container_pricing_card_4">
                                <?php echo form_open('promote_controller/pricing_post', ['onkeypress' => "return event.keyCode != 13;"]); ?>
                                <input type="hidden" name="product_id" value="<?php echo $product->id; ?>">
                                <input type="hidden" name="product_title" value="<?php echo $product->title; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 m-b-15">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="pricing_week_count" name="week_count" class="form-control form-input price-input" min="1" value="1" required>
                                        </div>
                                    </div>
                                    <div class="col-12 text-right">
                                        <?php if ($payment_settings->currency_symbol_format == "left"): ?>
                                            <strong class="price-total"><?php echo trans("total_amount"); ?>&nbsp;<?php echo get_currency($payment_settings->promoted_products_payment_currency); ?><span class="span-price-total-monthly"><?php echo $price_per_week; ?></span>&nbsp;<?php echo $payment_settings->promoted_products_payment_currency; ?></strong>
                                        <?php else: ?>
                                            <strong class="price-total"><?php echo trans("total_amount"); ?>&nbsp;<span class="span-price-total-monthly"><?php echo $price_per_week; ?></span><?php echo get_currency($payment_settings->promoted_products_payment_currency); ?>&nbsp;<?php echo $payment_settings->promoted_products_payment_currency; ?></strong>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-12 m-t-30">
                                        <button type="submit" class="btn btn-lg btn-custom float-right"><?php echo trans("continue_to_checkout"); ?></button>
...
<script>
    ...
    $("#pricing_week_count").on("input keypress paste change", function () {
        var week_count = $("#pricing_week_count").val();
        if (week_count > 36500) {
            week_count = 36500;
            $("#pricing_week_count").val('36500');
        }
        var price_per_week = '<?php echo price_format_decimal($payment_settings->price_per_week); ?>';
        var calculated = week_count * price_per_week;
        if (!Number.isInteger(calculated)) {
            calculated = calculated.toFixed(2);
        }
        <?php if($this->thousands_separator == ','): ?>
        ...
        var calculated_formatted = $.number(calculated, 2, '.', ',');
        <?php endif; ?>
        $(".span-price-total-week").text(calculated_formatted);
    });
