                ...
                <div class="shopping-cart shopping-cart-shipping">
                    <div class="row">
                        <div class="col-sm-12 col-lg-7">
                            <div class="left">
                                <h1 class="cart-section-title">Promosikan produk</h1>
                                <?php if (!auth_check()): ?>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <?php if ($payment_settings->bank_transfer_enabled): ?>
                                                        <li>
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label label-payment-option" for="option_bank">MIDTRANS&nbsp;<small>(Pembayaran online)</small>
                                                                </label>
                                                            </div>
                                                        </li>
                                                    <?php endif; ?>
                                            ...
                                            <div class="form-group m-t-15">
                                                <button id="pay-button" class="btn btn-lg btn-custom float-right">Selesai</button>
                                            </div>
                                        </div>
                                    </div>
