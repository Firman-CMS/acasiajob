...
<div id="wrapper">
            ...
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if($method=="bank_transfer"): ?>
                        <p class="p-complete-payment">Transaksi sukses dilakukan ,silahkan melihat daftar transaksi anda untuk melihat list transaksi dan detail transaksi</p>
 ...
 <div class="col-12 m-t-30">
     <form action="https://arenatani.com/transaksi">
    <input class="btn btn-lg btn-custom float-right" type="submit" value="Lihat transaksi" />
</form>
